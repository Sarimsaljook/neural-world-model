...
log = get_logger("nwm.train.stage5_probe_planner")
...
def run(cfg: Dict[str, Any]) -> None:
    ...
    log.info("Stage %s starting (max_steps=%d)", "stage5_probe_planner", max_steps)
    # Add: build dataloaders -> build models -> optimize -> save checkpoints.
    log.info("Stage %s complete", "stage5_probe_planner")
